    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                if(Build.VERSION.SDK_INT>=11) pulseAnimator = Utils.getPulseAnimator(mMonthAndDayView, 0.9f, 1.05f);
                if (mDelayAnimation) {
                 if(Build.VERSION.SDK_INT>=11)  pulseAnimator.setStartDelay(ANIMATION_DELAY);
                ...
                if(Build.VERSION.SDK_INT>=11)  pulseAnimator.start();
                ...
                break;
            case YEAR_VIEW:
                if(Build.VERSION.SDK_INT>=11) pulseAnimator = Utils.getPulseAnimator(mYearView, 0.85f, 1.1f);
                if (mDelayAnimation) {
                    if(Build.VERSION.SDK_INT>=11)   pulseAnimator.setStartDelay(ANIMATION_DELAY);
                    mDelayAnimation = false;
                }

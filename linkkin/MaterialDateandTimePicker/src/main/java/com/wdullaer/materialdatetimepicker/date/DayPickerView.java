...
public abstract class DayPickerView extends ListView implements OnScrollListener,
    ...
    protected void setUpListView() {
        ...
        if(Build.VERSION.SDK_INT>=11) setFriction(ViewConfiguration.getScrollFriction() * mFriction);
    }
    ...
    public boolean goTo(MonthAdapter.CalendarDay day, boolean animate, boolean setSelected, boolean forceScroll) {
        ...
        if (position != selectedPosition || forceScroll) {
            ...
            if (animate) {
                if(Build.VERSION.SDK_INT>=11) smoothScrollToPositionFromTop(position, LIST_TOP_OFFSET, GOTO_SCROLL_DURATION);

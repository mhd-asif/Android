...
//			html = String.format("<link rel=\"stylesheet\" type=\"text/css\" href=\"%s\" />" + html, cssFileUrl);
			//html = String.format("<link rel=\"stylesheet\" type=\"text/css\" href=\""+cssFileUrl+"\" />" + html);
		}

		StringBuilder sb = new StringBuilder().append("<link rel=\"stylesheet\" type=\"text/css\" href=\"");
		sb.append(""+cssFileUrl).append("\" />").append(html);
